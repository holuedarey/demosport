...
<div class="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <div class="page-title mb-4 d-flex align-items-center">
      <div class="mr-auto">
        <h4 class="weight500 d-inline-block pr-3 mr-3 border-right">Outstanding Users</h4>
      </div>
    </div>
    <!--/page title-->
          ...
          {{-- <div class="card-header border-0">
            <div class="custom-title-wrap bar-primary">
              ...
              <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModal"
                data-whatever="@mdo">Outstanding Users</button>
                  ...
                  <div id="exampleModal{{ $item->id }}" class="modal fade bd-example-modal-sm" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          Are you sure you want to pay this User?
                        </div>

                        <form action="/admin/outstanding/{{ $item->id }}" method="POST">
                          {{-- @csrf --}}
                          {{ csrf_field() }}
                          {{ method_field('PATCH') }}
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel5"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel5">Outstanding Users</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
