...
<body class="signin-up-bg">
    ...
    <div class="leftHalf" style="background-image: url('/assets/img/auth_logo.jpg')">
    ...
    <div class="rightHalf">
        <div class="position-relative">
            ...
            <div class="login-form">
                ...
                <img src="{{ asset('assets/img/demoa.png') }}" width="100" height="25" alt="CodeLab">
                </h2>
                <h4 class="text-uppercase- text-purple text-center mb-5">Admin Registration</h4>
                <form method="POST" action="{{ route('register') }}">
                        @csrf

                        <div class="form-group">
                        <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="name" placeholder="Enter name" value="{{ old('name') }}" required>
                    </div>

                    <div class="form-group">
                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="email" placeholder="Enter email" value="{{ old('email') }}" required>
                    </div>

                    <div class="form-group mb-4">
                        <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" id="password" placeholder="Enter Password" required>
                    </div>
